...
class getTwigService extends App_KernelDevDebugContainer
{
    ...
    {
        $a = new \Twig\Loader\FilesystemLoader([], 'F:\\Symfony_Lab3-main');
        $a->addPath('F:\\Symfony_Lab3-main\\vendor\\doctrine\\doctrine-bundle/Resources/views', 'Doctrine');
        $a->addPath('F:\\Symfony_Lab3-main\\vendor\\doctrine\\doctrine-bundle/Resources/views', '!Doctrine');
        $a->addPath('F:\\Symfony_Lab3-main/templates');
        $a->addPath('F:\\Symfony_Lab3-main\\vendor\\symfony\\twig-bridge/Resources/views/Form');
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(($container->privates['debug.file_link_formatter'] ?? ($container->privates['debug.file_link_formatter'] = new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter(NULL))), 'F:\\Symfony_Lab3-main', 'UTF-8'));
